...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://buildaringfarm.wiki'
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              Email: <a href="mailto:dmca@buildaringfarm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildaringfarm.wiki</a>
            </p>
            <p>
            ...
            <p>
              Example attribution: <em>"Source: Build A Ring Farm Wiki (buildaringfarm.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@buildaringfarm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@buildaringfarm.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@buildaringfarm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildaringfarm.wiki</a>
            </p>
            <p>
